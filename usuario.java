...
public class usuario extends javax.swing.JFrame {
    ...
    public void limpiar(){
        ...
        usuariotxt.setText("");
        clavetxt.setText("");
        confirmartxt.setText("");
        String correr=datos.valor("select max(idusuario)+1 from usuario");
        idusuariotxt.setText(correr);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Permisos cliente"));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(idusuariotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(confirmartxt, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(usuariotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (clavetxt.getText().length()<9)
        {
            JOptionPane.showMessageDialog(null, "Contraseña corta, porfavor alargala.");
            return ;
        }
        
        if (ck1.isSelected()==false && ck2.isSelected()==false && ck3.isSelected()==false)
        {
            JOptionPane.showMessageDialog(null, "Porfavor llena al menos uno de los cheques");
            return ;
        }
        
        if (clavetxt.getText().equals(confirmartxt.getText())==false)
        {
            JOptionPane.showMessageDialog(null, "No coiciden la clave con la confirmacion");
            return ;
        }
        
        
        
        String sql="INSERT INTO `usuario`( `usuario`, `clave`, `cargo`, `ccliente`, `ecliente`, `acliente`, `estado`)"
                + " VALUES ('"+usuariotxt.getText()+"','"+clavetxt.getText()+"','Cargo','"+ck1.isSelected()+"',"
                + "'"+ck2.isSelected()+"','"+ck3.isSelected()+"','1')";
